...
/** features/01-personal-information.md. Only firstName/lastName/email/address
 * are required — enforced here AND re-checked server-side (never trust the
 * client-only "required" styling the reference product relies on). */
